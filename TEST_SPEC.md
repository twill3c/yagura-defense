...
| T-040 | F-09 | セルのタップ / 再タップ / 別セル | 選択 → トグル解除 → 選択移動 |
| T-041 | F-09 | タワーのタップ / 再タップ / dismiss | タワー選択 → トグル解除 → 常に none |
| T-050 | F-04 | 大筒の 1 発と近接 2 体 | splashRadius 内の全員に max(1, dmg−def) |
| T-051 | F-04 | 札の被弾 | slowTicks の間 speed×slowFactor、再被弾で持続更新、切れたら復帰 |
| T-052 | F-05 | 兜武者へ札 / 弓 | 最低 1 ダメージ保証 / 防御分減衰 |
| T-053 | F-05 | 武者大将のリーク | ライフ −5 |
| T-054 | F-02/F-01 | MAP_01 5 ウェーブ化 | 構造検証合格・混成タワーのリプレイ決定性 |
| T-060 | F-07 | towerStats Lv1/Lv3 | 威力倍率(四捨五入)・射程ボーナス・付随効果維持 |
| T-061 | F-07 | upgrade | 費用控除・invested 累積・最大 Lv / 資金不足 / 不在 id 拒否 |
| T-062 | F-07/B-04 | sell | floor(invested×0.7) 払い戻し・強化込みでも資金は目減り |
| T-063 | F-07 | Lv2 弓の射撃 | 実効 dmg18 が命中に反映 |
| T-064 | F-08 | score | 撃破×10 + 残ライフ×100 + 残資金 |
| T-065 | F-07 | ウェーブ進行中 | upgrade / sell が受理される |
| T-100 | B-01 | MAP_01 タワー未設置 | ウェーブ 1 で 1 体以上リーク |
| T-101 | B-02 | 基準戦略(貪欲弓) | 全ウェーブクリア・残ライフ ≥ 1 |
